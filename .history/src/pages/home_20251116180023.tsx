...
const HomePage: React.FC<PageProps> = () => {
  return (
    <main style={pageStyles}>
      ...
      <p style={paragraphStyles}>Meet Lonnie Taylor, one of Santa's special helpers who is exited to become Santa at your next event and share his boundless Christmas cheer with every child he meets. <br /> Lonnie is a Santa who can seamlessly adapt to any holiday setting. Special‑needs friendly: He knows how to create a calm, sensory‑aware environment, works comfortably with wheelchairs, and uses gentle, patient communication techniques. Sign‑language fluent: Certified in American Sign Language, he can greet, converse, and read stories in ASL so deaf and hard‑of‑hearing children feel fully included.</p>
